...
function AllToursContainer() {
  ...
  useEffect(() => {
    fetchTourPreviews(`http://localhost:8080/api/v1/all-tours-previews`, queries, setData);
    setSkipCount(0);
  ...
  const showMoreHandler = () => {
    fetchTourPreviews(`http://localhost:8080/api/v1/all-tours-previews?skip=${skipCount + 6}`, queries, setData, true);
